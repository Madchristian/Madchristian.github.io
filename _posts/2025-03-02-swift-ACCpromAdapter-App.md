...
- **Headless Installation mit [ACCPromAdapterDaemon](https://github.com/Madchristian/ACCpromAdapterDaemon/releases/tag/Version1):** Für Umgebungen ohne Benutzeranmeldung, wie z. B. Server oder Headless Mac Minis, bietet der ACCPromAdapterDaemon eine vollständig automatisierte Lösung. Der Daemon startet beim Systemstart und liefert kontinuierlich Metriken, die von Prometheus abgefragt werden können.
